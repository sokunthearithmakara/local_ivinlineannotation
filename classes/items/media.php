...
class media extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement(
            'filemanager',
            'media',
            '<i class="bi bi-upload mx-2"></i>' . get_string($type . 'file', 'local_ivinlineannotation'),
            null,
            $filemanageroptions
        );
        ...
        $elementarray[] = $mform->createElement(
            ...
            'resizable',
            '',
            get_string('resizable', 'local_ivinlineannotation'),
            ['group' => 1],
            [0, 1]
        );
        ...
        $elementarray[] = $mform->createElement(
            ...
            'autoplay',
            '',
            get_string('autoplay', 'local_ivinlineannotation'),
            ['group' => 1],
            [0, 1]
        );
        ...
        $elementarray[] = $mform->createElement(
            ...
            'showcontrol',
            '',
            get_string('showcontrol', 'local_ivinlineannotation'),
            ['group' => 1],
            [0, 1]
        );
