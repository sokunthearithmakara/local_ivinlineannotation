...
class shape extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'shape', get_string('shape', 'local_ivinlineannotation'), [
            'rectangle' => get_string('rectangle', 'local_ivinlineannotation'),
            'circle' => get_string('circle', 'local_ivinlineannotation'),
        ]);
        ...
        $mform->addElement(
            'text',
            'bordercolor',
            get_string('bordercolor', 'local_ivinlineannotation') .
                '<span class="color-picker iv-ml-2" style="background-color: ' .
        ...
        $mform->addElement('text', 'opacity', get_string('opacity', 'local_ivinlineannotation'), ['size' => 100]);
