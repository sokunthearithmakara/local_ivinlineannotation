...
class textblock extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('textarea', 'label', get_string('textblock', 'local_ivinlineannotation'), ['size' => 100]);
        ...
        $mform->addElement('select', 'alignment', get_string('textalignment', 'local_ivinlineannotation'), [
            'left' => get_string('left', 'local_ivinlineannotation'),
