...
namespace local_ivinlineannotation;
...
class main extends \ivplugin_richtext\main {
    ...
    public function get_property() {
        return [
            ...
            'icon' => 'bi bi-pip-fill',
            'title' => get_string('inlineannotationcontent', 'local_ivinlineannotation'),
            'amdmodule' => 'local_ivinlineannotation/main',
            'class' => 'local_ivinlineannotation\\main',
            'form' => 'local_ivinlineannotation\\form',
            'hascompletion' => false,
            'hastimestamp' => true,
            'hasreport' => false,
            'description' => get_string('inlineannotationdescription', 'local_ivinlineannotation'),
            'author' => 'tsmakara',
            'authorlink' => 'mailto:sokunthearithmakara@gmail.com',
            'tutorial' => get_string('tutorialurl', 'local_ivinlineannotation'),
        ];
    }
