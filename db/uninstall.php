 ...
 */
/**
 * Uninstall function for the local_ivinlineannotation plugin.
 *
 * @return bool Always returns true.
 */
function xmldb_local_ivinlineannotation_uninstall() {
    $config = get_config('mod_interactivevideo', 'enablecontenttypes');
    $config = explode(',', $config);
    $config = array_diff($config, ['local_ivinlineannotation']);
